...
5. أعد فقط النص المطلوب المعالج وفق الهيكلية المحددة دون أي تحيات أو مقدمات أو خاتمة خارج النص.`;
...
- ممنوع منعاً باتاً استخدام كلمة (معتمد) أو مشتقاتها نهائياً واستبدالها بـ (المستخدمة/المطبقة).
...
أعد فقط النص المنظم بالأقسام الأربعة أعلاه دون أي إيموجيات ودون أي كلام إضافي أو مقدمات:\n\n${text}`;
        ...
        userPrompt = `أعد صياغة وترتيب وتوثيق سجل اليوم التالي وفق معايير التقييم الأكاديمي المبنية على الجدارات الهندسية ومخرجات التعلم (Competency-Based Technical Reporting):
...
(حصر البرمجيات أو الأجهزة أو المقاييس أو الكوابل أو البيئات المذكورة في النص فقط)
